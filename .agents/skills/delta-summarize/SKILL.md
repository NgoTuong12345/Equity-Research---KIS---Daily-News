---
name: delta-summarize
description: Summarize only newly added TAKE selections from Google Sheets without re-processing existing articles, then auto-chain to dedup-news.
---
